  ...
  shared_examples 'glare authtoken' do
    ...
    context 'with default parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_glare_config('keystone_authtoken/auth_url').with_value('http://localhost:35357')
        is_expected.to contain_glare_config('keystone_authtoken/project_name').with_value('services')
        is_expected.to contain_glare_config('keystone_authtoken/user_domain_name').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_glare_config('keystone_authtoken/project_domain_name').with_value('<SERVICE DEFAULT>')
        ...
        is_expected.to contain_glare_config('keystone_authtoken/auth_uri').with_value('http://localhost:5000')
        ...
        is_expected.to contain_glare_config('keystone_authtoken/check_revocations_for_cached').with_value('<SERVICE DEFAULT>')
        ...
        is_expected.to contain_glare_config('keystone_authtoken/hash_algorithms').with_value('<SERVICE DEFAULT>')
        ...
        is_expected.to contain_glare_config('keystone_authtoken/revocation_cache_time').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_glare_config('keystone_authtoken/signing_dir').with_value('<SERVICE DEFAULT>')
    ...
    context 'when overriding parameters' do
      ...
      it 'configure keystone_authtoken' do
        is_expected.to contain_glare_config('keystone_authtoken/auth_uri').with_value('https://10.0.0.1:9999/')
        ...
        is_expected.to contain_glare_config('keystone_authtoken/check_revocations_for_cached').with_value(params[:check_revocations_for_cached])
        ...
        is_expected.to contain_glare_config('keystone_authtoken/hash_algorithms').with_value(params[:hash_algorithms])
        ...
        is_expected.to contain_glare_config('keystone_authtoken/revocation_cache_time').with_value(params[:revocation_cache_time])
        is_expected.to contain_glare_config('keystone_authtoken/signing_dir').with_value(params[:signing_dir])
